...
const indexHandler = (response, callback) => {
  ...
  const homeHTML = {
    ...
    <tbody style="top:10px !important;position:relative;">
    <tr>
    ${(function(){
    let tempHTML = ``;
